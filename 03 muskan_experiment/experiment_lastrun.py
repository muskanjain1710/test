...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='/Users/pushkarsingh/Documents/01 University/02 Experimental Psychology/03 muskan_experiment/experiment_lastrun.py',
...
def run(expInfo, thisExp, win, inputs, globalClock=None, thisSession=None):
    ...
    # --- Initialize components for Routine "break_4" ---
    text_norm = visual.TextStim(win=win, name='text_norm',
        text='take a break, press the "spacebar" when you are ready to start the next phase',
        font='Arial',
    ...
    text = visual.TextStim(win=win, name='text',
        text='instructions for test phase',
        font='Open Sans',
    ...
    trials = data.TrialHandler(nReps=1.0, method='random', 
        ...
        trialList=data.importConditions('prep.xlsx'),
    ...
    for thisTrial in trials:
        ...
        trialComponents = [fixation, image]
    ...
    # --- Prepare to start Routine "break_4" ---
    continueRoutine = True
    # update component parameters for each repeat
    thisExp.addData('break_4.started', globalClock.getTime())
    key_instruct.keys = []
    key_instruct.rt = []
    _key_instruct_allKeys = []
    # keep track of which components have finished
    break_4Components = [text_norm, key_instruct]
    for thisComponent in break_4Components:
        thisComponent.tStart = None
        thisComponent.tStop = None
        thisComponent.tStartRefresh = None
        thisComponent.tStopRefresh = None
    ...
    # --- Ending Routine "break_4" ---
    for thisComponent in break_4Components:
        if hasattr(thisComponent, "setAutoDraw"):
            thisComponent.setAutoDraw(False)
    thisExp.addData('break_4.stopped', globalClock.getTime())
    # check responses
    ...
    thisExp.nextEntry()
    # the Routine "break_4" was not non-slip safe, so reset the non-slip timer
    routineTimer.reset()
    ...
    # keep track of which components have finished
    break_2Components = [text_countdown]
    ...
    trials_2 = data.TrialHandler(nReps=1.0, method='random', 
        extraInfo=expInfo, originPath=-1,
        trialList=data.importConditions('color_images.xlsx'),
    ...
    for thisTrial_2 in trials_2:
        ...
        while continueRoutine:
            ...
            if resp.status == STARTED and not waitOnFlip:
                theseKeys = resp.getKeys(keyList=['y','n'], ignoreKeys=["escape"], waitRelease=False)
        ...
        if (shown_before == 1 and resp.keys == "y" or shown_before == 0 and resp.keys == "n"):
